  ...
  <div align="center" style="padding:75px;">
    <table>
        <tr style="background-color:black;">
            <th style="padding:10px; font-size: 20px; color:white;">Name of the counsellor</th>
            <th style="padding:10px; font-size: 20px; color:white;">Date of appointment</th>
        ...
        <tr style="background-color:black;" align="center">
            <td style="padding:10px; font-size: 20px; color:white;">{{$appoints->counsellor}}</td>
            ...
            <td><a class="bt btn-danger" onclick="return confirm('are you sure that want to delete the appointment')" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</a></td>
